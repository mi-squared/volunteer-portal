...
class UploadsController extends BaseController
{
    ...
    public static function cloneUploads($SourceApplication, $TargetApplication)
    {
        // clone any uploads
        $uploads = Upload::where('application_id', '=', $SourceApplication['id'])->get();
        if ($uploads) {
            if (count($uploads) > 0) {
                foreach ($uploads as $upload) {
                    ...
                    $uploadMeta['application_id'] = $TargetApplication['id'];
